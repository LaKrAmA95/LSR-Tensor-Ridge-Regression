  ...
  for fold, (train_ids, validation_ids) in enumerate(kfold.split(X_train)):
      ...
      for index1, alpha1 in enumerate(alphas):
        ...
        #try:
          ...
          lsr_ten, objective_function_values,gradient_values,factor_core_iteration = lsr_bcd_regression(lsr_tensors[index1][fold], X_train_updated, Y_train_updated, hypers, intercept = need_intercept)
        ...
        #except Exception as e:
            ...
            #print(f"Fold:{fold} = {fold} Lambda {alpha1}: Error occurred during cross-validation{}")
            #continue
